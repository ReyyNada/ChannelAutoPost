...
Use the [usermode](https://github.com/ReyyNada/ChannelAutoPost/tree/user) branch, if you want to forward messages without being an admin in the from channel.
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/ReyyNada/ChannelAutoPost)
...
<br>
- Clone the repo:   <code>git clone https://github.com/ReyyNada/ChannelAutoForwarder</code></br>
- Make a <code>.env</code> file in the root of the repo, like <a href="https://github.com/ReyyNada/ChannelAutoForwarder/blob/main/.env.sample">.env.sample</a> and fill in the values.</br>
